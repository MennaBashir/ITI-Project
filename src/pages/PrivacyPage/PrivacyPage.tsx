  ...
  return (
    <section className="privacy container">
      ...
      <div className="single-content mb-50">
        <h4>Welcome to Matger Privacy Policy</h4>
        <ol start={1}>
          <li>
            Hi there, we,re Matger Pty Ltd (ABN 11 119 159 741) of Level 1, 121
            King Street Melbourne, 3000, Australia (“
            <strong>Matger</strong>”) and welcome to our privacy policy which
            also applies to our Affiliate Companies. This policy sets out how we
            handle your personal information if you're an Matger user or visitor
            to our Sites. It applies across Matger Elements, Matger Market,
            Matger Twenty20, Matger Studio, Matger Sites, Matger Tuts+ and
            Placeit (the “<strong>Sites</strong>”).
          </li>
          <li>
            When we say 'we', 'us' or 'Matger' it's because that's who we are
            and we own and run the Sites.
          </li>
          <li>
            If we say 'policy' we're talking about this privacy policy. If we
            say 'user terms' we're talking about the rules for using each of the
        ...
        <ol start={4}>
          ...
          <li>
            ...
            user-names, member names, email addresses, IP addresses, other
            contact details, survey responses, blogs, photos, payment
            ...
            or inputs into items) and web and email analytics data. We will also
            collect personal information from job applications (such as, your
        ...
        <ol start={6}>
          ...
          <li>
            ...
            integrity of our marketplaces by reducing fraud, making authors more
            accountable for their content and giving Matger and customers the
            ability to enforce contracts for authors who break the rules. Matger
            also has certain legal obligations that require us to know who our
            authors are in certain circumstances. In light of this, if you are
            an author we will verify your identity, in particular, your name,
            full address and date of birth by asking you to show us a Photo ID
            document. The verification procedure is called Matger Verify. Matger
            Verify will be carried out by our service provider Jumio Corporation
            located at 395 Page Mill Road, Suite 150, Palo Alto, California,
            USA. As part of Matger Verify, you will be asked to take a selfie
            which will then be compared against your Photo ID document using
            facial recognition technology. We will use your Photo ID document
            solely to carry out Matger Verify and delete it after the completion
            of this process.
          </li>
        </ol>
          ...
          <li>
            ...
            <ol>
              <li>
                ...
                located in the US, UK, and Australia in order to process a
                transaction;
              </li>
              <li>
                ...
                registration and profile from that service, this only occurs if
                you are using Matger Studio. The information varies and is
                controlled by that service provider or as authorized by you via
                your privacy settings at that service provider; and
              </li>
              <li>
                other third party sources/and or partners from Australia, US or
                UK, whereby we receive additional information about you (to the
                extent permitted by applicable law), such as demographic data or
                fraud detection information, and combine it with information we
                have about you. For example, fraud warnings from service
                providers like identity verification service. We also receive
                information about you and your activities on and off the Matger
                platform through partnerships, or about your experiences and
                interactions from our partner ad networks. We also receive
                information about you as a rights holder from our third party
                authors. For example, information in the form of a model release
                when your image is used in an item made available on our Sites.
              </li>
            </ol>
          </li>
        </ol>
            ...
            <ol>
              ...
              <li>
                ...
                <ol>
                  ...
                  <li>
                    updating you with operational news and information about our
                    Sites and services e.g. to notify you about changes to our
                    Sites, website disruptions or security updates;
                  </li>
                  <li>
                    carrying out technical analysis to determine how to improve
                    the Sites and services we provide;
                  </li>
                  <li>
                    monitoring activity on the Sites, e.g. to identify potential
                    fraudulent activity and to ensure compliance with the user
                    terms that apply to the Sites;
                  </li>
                  <li>
                  ...
                  <li>
                    training Matger staff about how to best serve our user
                    community;
                  </li>
                  ...
                  <li>
                    ...
                    or defense of legal claims); and
                  </li>
                  <li>processing your job application to Matger.</li>
                </ol>
              </li>
              <li>
        ...
        <ol start={11}>
          <li>
            ...
            <ol>
              <li>
                companies that are in the Matger group which are located in
                Australia, Mexico and the US;
              </li>
              <li>
                if applicable, authors of any items or services made available
                to you, so they can facilitate support and license validation,
                who maybe located in any of the countries our products are
                available in;
              </li>
              <li>
                ...
                Australia, US and UK; technical and customer support services
                which are located in Australia, Canada, Philippines, Poland,
                Mexico, Romania, UK and the US; recruitment agencies which are
                located in Australia, US and Mexico; marketing and analytics
                services which are located in the US; security and fraud
                prevention services which are located in the US; subscription
                management services which are located in the US; payment
                processing services which are located in the US, UK and
                Australia; identification verification services located in the
                UK; and operational tooling services which are located in the
                US. Noting that our subcontractors and services providers may
                also transfer and access such information from other countries
                in which they have operations.
              </li>
              <li>
                our professional advisers (lawyers, accountants, financial
                advisers etc.) which are located in Australia, Ireland, Mexico,
                UK and USA;
              </li>
              <li>
        ...
        <ol start={12}>
          <li>
            We are based in Australia and Mexico so your data will be processed
            in Australia, Mexico and the US. Some of the recipients we have
            described in section 10 above, and to whom we disclose your personal
            information, are based in places like Australia, Canada, Ireland,
            Mexico, Philippines, Poland, Romania, UK, the US, India and
            Columbia. We do this on the basis of this policy. In order to
            protect your information, we take care where possible to work with
        ...
        <ol start={13}>
          <li>
            We store personal information on secure servers that are managed by
            us and our service providers, and occasionally hard copy files that
            are kept in a secure location in Australia, Ireland, Mexico and the
            US. Personal information that we store or transmit is protected by
        ...
        <ol start={14}>
          <li>
            ...
            about you by logging in to your account. You also have the right to
            make a request to access other personal information we hold about
            you and to request corrections of any errors in that data. You can
            also close the account you have with us for any of our Sites at any
            time. To make an access or correction request, contact our privacy
            champion using the contact details at the end of this policy.
          </li>
        </ol>
        ...
        <ol start={15}>
          <li>
            ...
            you would prefer not to receive them in the future by using the
          ...
          <li>
            ...
            cookies. If you choose to reject cookies some parts of our Sites may
        ...
        <ol start={17}>
          <li>
            ...
            <a href="https://Matger.com/cookies/">here</a> and for more general
          ...
          <li>
            ...
            ads based on prior visits to our Sites. For example, if you visit
            our Sites, you may later see an add for our products and services
            when you visit a different Site. Read more about your options in our{" "}
            <a href="https://Matger.com/cookies/">cookie policy</a>.
          </li>
        </ol>
        ...
        <ol start={20}>
          <li>
            ...
            so if you are under 16 we ask that you do not use our Sites or give
            us your personal information (if you are a young tech wiz, please
            direct your nearest responsible adult to use the Sites for you!). If
            you are from 16 to 18 years, you can browse the Sites but you'll
            need the supervision of a parent or guardian to become a registered
            user. It's the responsibility of parents or guardians to monitor
        ...
        <ol start={21}>
          <li>
            ...
            message on a forum thread, share information via social media, or
            make contact with another user (such as a third party Author)
            ...
            else, think carefully. If giving information to another user via our
            Sites, ask them how they will handle your information. If you're
            sharing information via another website, check the privacy policy
            for that site to understand its information management practices as
        ...
        <ol start={22}>
          <li>
            ...
            information or to provide you with the Matger services, you can
            request that we erase your personal information and close your
            Matger account. Please note that if you request the erasure of your
            ...
            government, a court of law, or law enforcement authorities, enforce
            the terms of service and take other actions permitted by law. The
            information we retain will be handled in accordance with this
            Privacy Policy.
          </li>
        </ol>
        ...
        <ol start={25}>
          <li>
            ...
            which we have been managing your personal information, please
            contact our privacy champion in writing at PO Box 16122 Collins
            Street West Victoria 8007 Australia or{" "}
            <a href="mailto:menna.bashiir@gmail.com">
              privacy.menna.bashiir@gmail.com
            </a>
            .
          </li>
          <li>
        ...
        <ol start={1}>
          <li>
            ...
            <strong>GDPR</strong>”), we are a 'data controller' of your personal
            information.
          </li>
        </ol>
        <h4>How you can access your personal information</h4>
